    ...
    return {
      ...
      link: function postLink(scope, element) {
        ...
        raphaelService.then(function (raphael) {
          ...
          var commandsFactory = paper.circle(parent.offsetWidth / 2, 32, 20).attr('fill', 'rgb(214, 223, 254)');
          var destinationsFactory = paper.circle(parent.offsetWidth - 62, 32, 20).attr('fill', 'rgb(255, 255, 255)');
          controls.push(conditionsFactory,
            commandsFactory,
            destinationsFactory);
          controls.attr('stroke-width', '3');

          var conditionsFactoryGlow = conditionsFactory.glow().hide();
          conditionsFactory.hover(function () {
            conditionsFactoryGlow.show();
          }, function () {
            conditionsFactoryGlow.hide();
          });

          var newCondition;
          var x, y, conditions = [];
          conditionsFactory.click(function () {
...
//    paper.freeTransform(elements[i], {}, print);
//  }
//
//  function print(subject, events) {
//    if (subject) {
//      $('#details').html(
//        'x: ' + subject.attrs.x.toFixed(0) + '<br/>' +
//        'y: ' + subject.attrs.y.toFixed(0) + '<br/>' +
//        'center.x: ' + subject.attrs.center.x.toFixed(0) + '<br/>' +
//        'center.y: ' + subject.attrs.center.y.toFixed(0) + '<br/>' +
//        'rotate: ' + subject.attrs.rotate.toFixed(2) + '<br/>' +
//        'scale.x: ' + subject.attrs.scale.x.toFixed(2) + '<br/>' +
//        'scale.y: ' + subject.attrs.scale.y.toFixed(2) + '<br/>' +
//        'size.x: ' + subject.attrs.size.x.toFixed(0) + '<br/>' +
//        'size.y: ' + subject.attrs.size.y.toFixed(0) + '<br/>' +
//        'translate.x: ' + subject.attrs.translate.x.toFixed(0) + '<br/>' +
//        'translate.y: ' + subject.attrs.translate.y.toFixed(0) + '<br/>' +
//        'items: ' + subject.items.length.toFixed(0) + '<br/>' +
//        'events: ' + events.join(', ')
//      );
//    }
//  }
...
//      };
//
//      var callback = $('#callback').is(':checked') ? print : false;
//
//      if (!callback) {
//        $('#details:visible')
//          .stop()
//          .animate({left: -40, opacity: 0}, 200, function () {
//            $(this).hide();
//          });
//      } else {
//        $('#details:hidden')
